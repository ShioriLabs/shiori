...
ava_1.default('gets staff data correctly', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var staff;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, anilistQueries_1.default.getStaff('kana hanazawa')];
            case 1:
                staff = _a.sent();
...
ava_1.default('gets anime data correctly', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var anime;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, anilistQueries_1.default.getAnime('your lie in april')];
            case 1:
                anime = _a.sent();
